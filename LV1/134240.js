...
// 내 풀이
// const solution = (food) => {
//   const result = food.reverse().reduce((acc, cur, idx) => {
//     if (idx === food.length - 1) return acc;

//     const count = Math.floor(cur / 2);

//     if (count === 0) return acc;

//     for (let i = 0; i < count; i++) {
//       acc.push(food.length - 1 - idx);
//       acc.unshift(food.length - 1 - idx);
//     }
//     return acc;
//   }, []);
